	...
	handleError: function(error){
		switch(error.code) {
			case error.PERMISSION_DENIED:
				toastIt("User denied the request for Geolocation.");
				break;
			case error.POSITION_UNAVAILABLE:
				toastIt("Location information is unavailable.");
				break;
			case error.TIMEOUT:
				toastIt("The request to get user location timed out.");
				break;
			case error.UNKNOWN_ERROR:
				toastIt("An unknown error occurred.");
				break;
		}
		this.setState({showAlternative: true});
	},
